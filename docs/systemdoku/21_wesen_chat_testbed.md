...
**Weiterhin offen:** kein automatischer Verdichtungs-Rhythmus (z.B. alle 10 Nachrichten, oder größere Nachrichten ab X Tokens sofort einzeln) — nur manuell ausgelöst, kein Auftrag dafür bisher. Kein Popup zum nachträglichen Lesen/Löschen bereits bestehender Verdichtungen außerhalb der Verdichten-Modal-Liste selbst. Provenienz-Ereignis "Gesprächsabschnitt verdichtet" erscheint in der Chat-Ansicht/im Verlaufs-Export weiterhin an seiner Timestamp-Position (wann geklickt wurde), nicht an der logischen Position direkt nach den abgedeckten Original-Nachrichten — Daniel hat das als Lücke benannt, noch nicht behoben. Ebenso: der ctx-Meter im Header zählt weiterhin die volle, sichtbare Rohtext-Länge aller Nachrichten und berücksichtigt bestätigte Verdichtungen nicht — zeigt nach einer Verdichtung also keine Reduktion an, obwohl der tatsächliche Modell-Kontext geschrumpft ist.
