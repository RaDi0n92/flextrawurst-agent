...
# CURRENT 008  NICHT 17 SONDERN 333 MDS
> **Rohtext:** unverändert als eigener Gesprächskörper bewahrt.

<!-- RAWTEXT_BEGIN -->
das sind doch wider nur 17 mds und nicht die 333
<!-- RAWTEXT_END -->
...
- [Vorheriger Knoten](FW-RAW-CURRENT-007__CURRENT_007_SESSIONBEGINN_WAR_GLASKLAR.md) · `FW-RAW-CURRENT-007`
- [Nächster Knoten](FW-RAW-CURRENT-009__CURRENT_009_UEBER_ZWEI_STUNDEN.md) · `FW-RAW-CURRENT-009`
