#!/usr/bin/env python3
"""
Automatischer Zwischenraum-Scan für Codex.
...
ABWUERFE_LOG   = Path("/root/werkraum/_codex/abwuerfe.md")
TIMESTAMP_FILE = Path("/root/werkraum/_codex/tools/.letzter_zwischenraum_scan")
SCAN_INTERVAL  = 900  # 15 Minuten


def _token():
    return create_token("codex-abwurf", "admin")
...
def _moechte_einsammeln(splitter: dict) -> bool:
    score = 0.0
    if splitter.get("entity_id") == "codex":
        score += 0.4
