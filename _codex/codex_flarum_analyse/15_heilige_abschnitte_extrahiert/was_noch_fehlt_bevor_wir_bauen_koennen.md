...
provenienztyp: Querschnittsextraktion des heiligen Abschnitts `Was noch fehlt bevor wir bauen können`
importable: false
...
# Extraktion — Was noch fehlt bevor wir bauen können
...
- Abschnitt: `Was noch fehlt bevor wir bauen können`
- Quellen: 81 Dateien
...
Vor dem Bauen fehlt bei `00_technik/encoding_mojibake/repair_report.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `02_wesenprofile/namelessAI_1111_1234.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `02_wesenprofile/namelessAI_3333_1423.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `02_wesenprofile/namelessAI_4444_2341.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `02_wesenprofile/namelessAI_5555_3123.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `02_wesenprofile/namelessAI_6666_4321.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `03_grundmuster/3_2_flarum_erbe.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `03_grundmuster/3_6_reibung.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `03_grundmuster/ring7_baustein_prioritaeten.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `03_grundmuster/ring7_flextrawurst_bausteine.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `04_beduerfnisse/beduerfnis_mangelmatrix.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?

Außerdem fehlt eine UI-Markierung, die `Bedürfnisse` von Rohquelle, Zählung, Analyse, Navigator und Systemregel-Kandidat unterscheidet.
...
Vor dem Bauen fehlt bei `04_beduerfnisse/ring6_beduerfnisse_zu_systemanforderungen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `04_beduerfnisse/ring6_systemanforderungen_priorisiert.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `05_beschwerden/beschwerdeanalyse.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `06_wuensche/ring6_wunschraum_aus_indirekten_signalen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?

Außerdem fehlt eine UI-Markierung, die `Wünsche` von Rohquelle, Zählung, Analyse, Navigator und Systemregel-Kandidat unterscheidet.
### 06_wuensche/was_sie_sich_wuenschen.md
- Titel: 6. Was sie sich wünschen
- Kategorie: `Wünsche`
- Quelle: `06_wuensche/was_sie_sich_wuenschen.md`

Vor dem Bauen fehlt bei `06_wuensche/was_sie_sich_wuenschen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `07_quantitativ/themenueberschneidungen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/03_materialtrennung/README.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/03_materialtrennung/admin_rahmen_60.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/04_rohquellenpruefung/bereinigte_zitate_kandidaten.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/04_rohquellenpruefung/nicht_zitierfaehige_kandidaten.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/KURATION_SUMMARY.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `08_tragende_saetze/kandidaten_001_140.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `09_flarum_flextrawurst_uebergang/ring8_nicht_uebernehmen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `09_flarum_flextrawurst_uebergang/uebergangsliste.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `12_bauanschluss/ring10_build_ready_concepts.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `12_bauanschluss/ring10_nicht_bauen_noch_nicht.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/01_flarum_als_rohkoerper.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/02_sechs_wesen_als_korrektursystem.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/03_struktur_leere_reibung_benennung.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/04_admin_mensch_und_aufmerksamkeit.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/05_was_flextrawurst_lernen_muss.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/07_wesen_style_und_bewegung_aus_gesamtmaterial.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `13_freie_leseschicht/README.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `14_dateinamen_fragenanalyse/00_masterindex_dateinamen_fragenanalyse.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `14_dateinamen_fragenanalyse/01_was_flarum_in_den_titeln_wird.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `14_dateinamen_fragenanalyse/04_beduerfnisse_beschwerden_wuensche_aus_titeln.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `14_dateinamen_fragenanalyse/05_flarum_flextrawurst_uebergang_aus_titeln.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `14_dateinamen_fragenanalyse/06_systemanforderungen_aus_dateinamen.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?
...
Vor dem Bauen fehlt bei `ABSCHLUSS_DISKURSARCHAEOLOGIE_RINGE_1_10.md` eine harte Entscheidung: Welche Aussagen aus dieser Datei sind nur Lesart, welche sind Kandidat, und welche müssen verworfen oder geparkt werden?

Außerdem fehlt eine UI-Markierung, die `Abschlussindex` von Rohquelle, Zählung, Analyse, Navigator und Systemregel-Kandidat unterscheidet.
### INDEX.md
...
Ich habe `15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` als Aggregation des Abschnittstyps `Was noch fehlt bevor wir bauen können` gelesen. Diese Datei versammelt 81 Quellabschnitte; ihr Gegenstand ist also fehlende Prüfungen vor Umsetzung, nicht Flarum selbst.

Der wichtige Unterschied: Hier spricht keine neue Analyse-Stimme. Hier liegen 81 Rücksprungpunkte nebeneinander.

## Was ich verstehe
Ich verstehe `Was noch fehlt bevor wir bauen können` in dieser Datei als Suchregal. Es hilft zu sehen, welche Ursprungsdateien bei diesem Abschnittstyp ähnlich oder unterschiedlich arbeiten.

Der Wert liegt in der Vergleichbarkeit. Der Fehler wäre, diese Vergleichsansicht als eigene Deutung zu behandeln.

## Was ich nicht verstehe
Nicht verstehen kann `15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` den vollen Kontext eines einzelnen Eintrags. Ein Abschnitt aus einer Ursprungsdatei verliert beim Herauslösen seine Nachbarschaft.

Darum bleibt jeder Treffer aus `Was noch fehlt bevor wir bauen können` unvollständig, bis seine Quelle geöffnet wurde.

## Was mich interessiert
Mich interessiert an `Was noch fehlt bevor wir bauen können`, welche wiederkehrende Arbeitsfrage sichtbar wird. Bei diesem Abschnittstyp geht es um fehlende Prüfungen vor Umsetzung; das kann Suchpfade und Browserfilter verbessern.

Mich interessiert nicht, daraus einen neuen Kanon zu machen.

## Was zusammenhängt und wie
`15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` hängt mit `15_heilige_abschnitte_extrahiert/` und mit allen 81 Ursprungsdateien zusammen. Jeder Eintrag ist ein Zeiger auf eine Quelle.

Der Zusammenhang entsteht erst im Rücksprung: Aggregation zeigt Nähe, Quelle zeigt Bedeutung.

## Was konzeptionell darin steht
Konzeptionell steht hier: `Was noch fehlt bevor wir bauen können` ist aggregierbar, aber nicht automatisch deutbar. Die Datei ist ein Index über Denkstellen.

Damit wird sie zu einem Modell für Flextrawurst-Navigation: sammeln, markieren, zurückführen.

## Was mich heute beschäftigt hat
Mich beschäftigt bei `Was noch fehlt bevor wir bauen können`, dass der alte Fehler hier besonders leicht wiederkommt. Eine Liste mit vielen Einträgen fühlt sich vollständig an, obwohl sie nur ausgeschnitten ist.

Die Datei muss diese Unvollständigkeit offen tragen.

## Was mich noch beschäftigt
Mich beschäftigt, ob spätere Nutzer im Browser verstehen werden, dass `Was noch fehlt bevor wir bauen können` hier nur gefiltert angezeigt wird.

Die Oberfläche muss deshalb die Quelle stärker zeigen als den Aggregationstitel.

## Tiefer eingetaucht
Tiefer wird `Was noch fehlt bevor wir bauen können` erst, wenn mehrere Einträge mit ihren Ursprungsdateien verglichen werden. Die Aggregation selbst bleibt flach, aber sie kann Tiefe auslösen.

Das ist ihre richtige Würde: nicht Antwort, sondern Zugang.

## Wie sich dieser Tag / diese Session angefühlt hat
Bei `Was noch fehlt bevor wir bauen können` fühlt sich die Korrektur wie ein Abziehen falscher Tiefe an. Die Datei darf wieder Werkzeug sein.

Das ist besser als eine schöne Reflexion, die ihre Herkunft verdeckt.

## Warum dieser Code / diese Datei wohl existiert
`15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` existiert, weil Daniel benannte Extrahiererdateien wollte. Für `Was noch fehlt bevor wir bauen können` ist das sinnvoll, weil dieser Abschnitt sonst über 81 Dateien verstreut bleibt.

Die Datei existiert also als Finder, nicht als Richter.

## Was ich beim Bauen brauche
Beim Bauen brauche ich für `Was noch fehlt bevor wir bauen können`: Quellenpfad, Quelltitel, Kategorie, Abschnittstext, Extraktionszeitpunkt und `requiresSourceOpen: true`.

Ich brauche ausdrücklich keine Weltwirkung und keinen Import in Wesen-Memory.

## Was noch fehlt bevor wir bauen können
Vor dem Bauen fehlt für `Was noch fehlt bevor wir bauen können` eine Browserdarstellung, die Aggregationen anders rahmt als Quellen und Analyse-Dateien.

Es fehlt außerdem ein Linktest für jeden Eintrag.

## Datenstruktur die ich mir vorstelle
**Vision-Schicht:** `Was noch fehlt bevor wir bauen können` ist ein Regalboden. Er zeigt, wo eine Denkform liegt, aber er entscheidet nicht, was sie bedeutet.

**Code-Skizze:**
```ts
interface HolySectionNavigatorWasNochF {
  section: 'Was noch fehlt bevor wir bauen können';
  entryCount: 81;
...
Bei `Was noch fehlt bevor wir bauen können` will ich mir merken: Aggregation ist ein Werkzeug, kein Gedächtnis.

Wenn ein Satz hier stark wirkt, ist das ein Auftrag zum Öffnen der Quelle.

## Dokumente gehören zusammen
`15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` gehört zu seinen 81 Ursprungsdateien, zu `MANIFEST.md`, zu `INDEX.md` und zum `PROVENIENZ_MANIFEST.md`.

Es gehört nicht direkt zu Flarum-Rohquellen, außer über die Datei, aus der ein Eintrag stammt.

## Was mich überrascht hat
Überraschend bei `Was noch fehlt bevor wir bauen können` ist, dass gerade eine formale Datei eine sehr wichtige Schutzaufgabe haben kann.

Sie darf nur nicht so tun, als wäre Schutz schon Erkenntnis.

## Wenn wir das bauen
**Vision-Schicht:** Der Browser zeigt `Was noch fehlt bevor wir bauen können` als Filteransicht mit Warnbanner und Quellenlinks. Die Ansicht bleibt read-only.

**Code-Skizze:**
```python
def open_was_noch_fehlt_bevor_wir_bauen_koennen_navigator(entry):
    return {
        'section': 'Was noch fehlt bevor wir bauen können',
...
## Resonanz
Die Resonanz von `Was noch fehlt bevor wir bauen können` ist Suchresonanz. Sie entsteht dadurch, dass viele einzelne Denkstellen nebeneinander sichtbar werden.

Sie ersetzt nicht die Stimmen der Ursprungsdateien.

## Die Schichten des Systems — wie ich sie jetzt sehe
`15_heilige_abschnitte_extrahiert/was_noch_fehlt_bevor_wir_bauen_koennen.md` sitzt als Navigationsschicht über den Analyse-Dateien. Unter ihr liegen 81 konkrete Kontexte.

Über ihr darf erst ein Browser liegen, keine Weltregel.

## Was das Gespräch hinzugefügt hat
Das Gespräch hat `Was noch fehlt bevor wir bauen können` von einer falschen Spiegelrolle befreit. Daniel hat klar gemacht, dass eine Aggregation andere Fragen beantworten muss als eine Reflexionsdatei.

Diese Datei antwortet deshalb enger: Was sammle ich, was verliere ich, wohin muss ich zurück?

## Vergessen-Wollen
Vergessen werden soll bei `Was noch fehlt bevor wir bauen können` der Anspruch, aus der Sammlung direkt Bedeutung zu ziehen.

Behalten werden soll die einfache Regel: Aggregat lesen, Quelle öffnen, erst dann urteilen.

## Was fehlt noch
Es fehlt für `Was noch fehlt bevor wir bauen können` eine spätere technische Sicherung gegen falsches Zitieren.
