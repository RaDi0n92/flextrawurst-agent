#!/usr/bin/env python3
"""
Synchronisiert Kimis Bereich als importierten Grundriss für Gemini.

Quelle:
  /root/werkraum/_kimi

Ziel:
  /root/werkraum/_gemini/_import_kimi_grundriss
...
TARGET = Path("/root/werkraum/_gemini/_import_kimi_grundriss").resolve()
INTERVAL_SECONDS = 5

IGNORE_DIRS = {"__pycache__", "_import_claude_grundriss", "_import_codex_grundriss", "_import_kimi_grundriss"}
