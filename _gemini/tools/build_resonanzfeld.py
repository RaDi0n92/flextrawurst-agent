#!/usr/bin/env python3
"""
Kompiliert RESONANZFELD.md aus allen resonanz/-Dimensionsdateien für Gemini.
...
RESONANZFELD  = Path("/root/werkraum/_gemini/RESONANZFELD.md")
...
def main():
    ...
    zeilen = [
        ...
        "Nicht manuell bearbeiten. Quelle: `python3 _gemini/tools/build_resonanzfeld.py`\n",
        "\n---\n",
    ]
