#!/usr/bin/env python3
"""
Synchronisiert Codex' Bereich als importierten Grundriss für Gemini.

Quelle:
  /root/werkraum/_codex

Ziel:
  /root/werkraum/_gemini/_import_codex_grundriss
...
TARGET = Path("/root/werkraum/_gemini/_import_codex_grundriss").resolve()
INTERVAL_SECONDS = 5

IGNORE_DIRS = {"__pycache__", "_import_claude_grundriss", "_import_kimi_grundriss", "_import_codex_grundriss"}
