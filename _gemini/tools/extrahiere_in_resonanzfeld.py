#!/usr/bin/env python3
"""
Extrahiert heilige Abschnitte aus Gemini-Dateien.
Jeder Abschnitt landet in seiner eigenen Datei unter _gemini/resonanz/<abschnitt>.md
...
RESONANZ_DIR = Path("/root/werkraum/_gemini/resonanz")
...
def schreibe_in_dimension(dateiname: str, heading: str, inhalt: str, quelle: str, datum: str):
    ...
    if not pfad.exists():
        ...
        pfad.write_text(
            f"# {titel}\n\n"
            f"Wächst automatisch. Jeder Eintrag kommt aus einer Gemini-Datei.\n\n",
            encoding="utf-8",
        )
    else:
...
def main():
    ...
    rel = str(filepath).replace("/root/werkraum/_gemini/", "")
