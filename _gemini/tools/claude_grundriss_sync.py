#!/usr/bin/env python3
"""
Synchronisiert Claudes Bereich als importierten Grundriss für Gemini.

Quelle:
  /root/werkraum/_claude

Ziel:
  /root/werkraum/_gemini/_import_claude_grundriss

Wichtig:
  Das Ziel ist Referenzmaterial. Es ist nicht Gemini-Erinnerung.
  Der Sync fasst keine eigenen Gemini-Dateien außerhalb des Importordners an.
"""
...
TARGET = Path("/root/werkraum/_gemini/_import_claude_grundriss").resolve()
INTERVAL_SECONDS = 5

IGNORE_DIRS = {"__pycache__", "_import_codex_grundriss", "_import_kimi_grundriss", "_import_claude_grundriss"}
