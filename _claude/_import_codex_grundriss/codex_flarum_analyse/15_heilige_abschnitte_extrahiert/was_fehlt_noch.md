...
provenienztyp: Querschnittsextraktion des heiligen Abschnitts `Was fehlt noch`
importable: false
...
Ich habe diese Datei nach Daniels Kritik nicht mehr als eigene Analyse gelesen, sondern als problematische Aggregation. Ihr Gegenstand ist `Was fehlt noch`; ihr Material stammt aus 81 bereits geschriebenen Analyse-Dateien, nicht direkt aus Flarum.
