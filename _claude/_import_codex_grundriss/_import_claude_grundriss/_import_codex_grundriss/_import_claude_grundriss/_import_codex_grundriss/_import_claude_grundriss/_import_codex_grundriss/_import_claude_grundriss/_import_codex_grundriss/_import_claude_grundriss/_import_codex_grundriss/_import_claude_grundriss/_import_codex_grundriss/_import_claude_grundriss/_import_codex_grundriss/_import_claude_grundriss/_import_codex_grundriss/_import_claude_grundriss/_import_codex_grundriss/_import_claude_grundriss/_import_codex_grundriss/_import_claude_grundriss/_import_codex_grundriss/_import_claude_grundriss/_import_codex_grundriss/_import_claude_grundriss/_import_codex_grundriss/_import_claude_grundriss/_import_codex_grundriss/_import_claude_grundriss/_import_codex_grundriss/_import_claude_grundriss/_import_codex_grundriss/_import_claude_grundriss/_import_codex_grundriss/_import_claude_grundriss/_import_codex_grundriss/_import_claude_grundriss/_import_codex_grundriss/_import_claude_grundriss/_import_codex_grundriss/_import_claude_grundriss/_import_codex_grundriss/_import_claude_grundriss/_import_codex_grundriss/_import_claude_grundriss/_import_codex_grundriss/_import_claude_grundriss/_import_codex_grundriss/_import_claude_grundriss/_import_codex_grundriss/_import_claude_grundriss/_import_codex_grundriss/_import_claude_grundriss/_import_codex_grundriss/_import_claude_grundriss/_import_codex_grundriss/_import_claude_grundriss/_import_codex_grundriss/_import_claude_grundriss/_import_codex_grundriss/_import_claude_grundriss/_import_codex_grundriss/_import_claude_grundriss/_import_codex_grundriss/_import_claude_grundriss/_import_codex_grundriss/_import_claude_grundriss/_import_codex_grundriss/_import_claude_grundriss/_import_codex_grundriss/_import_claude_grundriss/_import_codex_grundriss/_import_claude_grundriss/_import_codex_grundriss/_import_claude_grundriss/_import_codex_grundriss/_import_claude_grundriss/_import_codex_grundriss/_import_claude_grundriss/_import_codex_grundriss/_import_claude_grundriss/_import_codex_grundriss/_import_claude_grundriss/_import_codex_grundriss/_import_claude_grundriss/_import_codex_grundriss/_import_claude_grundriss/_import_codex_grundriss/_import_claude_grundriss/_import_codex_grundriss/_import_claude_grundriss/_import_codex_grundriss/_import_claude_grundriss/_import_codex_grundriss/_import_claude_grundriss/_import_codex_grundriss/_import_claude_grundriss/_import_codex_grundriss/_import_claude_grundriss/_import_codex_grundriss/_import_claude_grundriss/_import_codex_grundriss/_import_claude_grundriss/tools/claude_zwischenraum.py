#!/usr/bin/env python3
"""
Claude liest den Zwischenraum und kann Splitter einsammeln.

Aufruf:
  python3 claude_zwischenraum.py          → listet aktive Splitter
  python3 claude_zwischenraum.py <id>     → sammelt Splitter mit dieser ID ein
"""
