...
die ich (Claude) vielleicht nicht explizit gesehen habe.
Ergebnis: _claude/ideen/synthese_YYYY-MM-DD.md
"""
import os
import json
import datetime
...
SPIEGEL_DIR = "/root/werkraum/_claude/spiegel"
OUTPUT_DIR  = "/root/werkraum/_claude/ideen"
...
def main():
    ...
    prompt = f"""Du liest Reflexionen eines KI-Systems (Claude) über ein Projekt namens flextrawurst.
Das System hat diese Reflexionen selbst geschrieben. Du bist nicht Claude.
...
*Nicht von Claude. Generiert von Ollama/{MODELL} während Claude schlief.*
