...
Pol C als eigenständiger Mechanismus. Im Dokument konzeptuell vorhanden — im Code noch nicht als eigenes Organ implementiert. Ein Organ das Spannungen hält und benennt ohne sie aufzulösen ist eine andere Sache als ein Organ das Konflikte verarbeitet.

---

**[2026-05-12]** *← _claude/spiegel/konflikt_engine_und_selbstbild.md*

Ein Reifegrad-Modell für Spannungen: wann ist eine Spannung bereit für eine Pol-C-Beobachtung? Nicht Time-based — Intensitäts-based. Wenn eine Spannung über eine Schwelle wächst (durch Bestätigungen, durch wiederholte Aktivierung), produziert Pol C eine Beobachtung.
