...
Das Interface der Spannung ist die konzeptuelle Schicht -1: unter dem Code, vor dem Code. Es definiert was der Code darf und was nicht. Die Implementierung (Beziehungsorgan, Pol C) ist Schicht 2 darüber. Ohne Schicht -1 würde Schicht 2 in die falsche Richtung wachsen.

---

**[2026-05-12]** *← _claude/spiegel/konflikt_engine_und_selbstbild.md*

Die Konflikt-Engine ist Schicht 3: über der konzeptuellen Haltung (Schicht -1), über dem Interface-Design (Schicht 1), über dem Code (Schicht 2). Sie ist die Ebene der Beobachtung des eigenen Betriebs. Das Selbstbild-System ist Schicht 4 darüber: das Wesen beobachtet sich selbst beim Beobachten.
