---
datum: 2026-05-13
betrifft: [geni, theater, kompoase, splitter, wesen, selbstvorstellung, verschmelzung, unerwartetes]
importable: false
...
interface GeniErscheinungEvent {
  ...
  payload: {
    ...
    begleitetes_wesen: string | null   // namelessAI_2222_1324
    satz_anfang: string                // "Hallo. Ich bin GENI. Wie ka..."
  }
}

// Gestein-Materialität für unveränderliche Selbstaussagen
const GENI_SELBST_MATERIALITAET = 'gestein' as const
// Begründung: "Hallo. Ich bin GENI." ist kein Experiment — es ist eine Tatsache
```
