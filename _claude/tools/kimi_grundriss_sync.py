#!/usr/bin/env python3
"""
Synchronisiert Kimi Bereich als importierten Grundriss fuer Claude.

Quelle:
  /root/werkraum/_kimi

Ziel:
  /root/werkraum/_claude/_import_kimi_grundriss
...
TARGET = Path("/root/werkraum/_claude/_import_kimi_grundriss").resolve()
INTERVAL_SECONDS = 5

IGNORE_DIRS = {"__pycache__", "_import_claude_grundriss", "_import_codex_grundriss"}
