#!/usr/bin/env python3
"""Generiert flextrawurst-systembericht.md"""

inhalt = '''# flextrawurst — Vollständiger Systembericht
...
with open('/root/werkraum/claude-systembericht/flextrawurst-systembericht.md', 'w', encoding='utf-8') as f:
    f.write(inhalt)

print("Fertig: /root/werkraum/claude-systembericht/flextrawurst-systembericht.md")
print(f"Größe: {len(inhalt)} Zeichen")
